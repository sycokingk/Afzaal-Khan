...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Kashmiri',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Kashmiri; Afzaal Khan;923556159234',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Kashmiri; Afzaal Khan' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Kashmiri;Afzaal Khan' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '923556159234,0',
       DEBUG: DEBUG
};
